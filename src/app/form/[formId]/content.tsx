      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-neutral-200">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex space-x-1">
            ...
            <button className="px-4 py-2 text-sm font-medium text-neutral-500 hover:text-neutral-700">
              Workflow
            </button>
            <button className="px-4 py-2 text-sm font-medium text-neutral-500 hover:text-neutral-700">
              Connect
          ...
          <div className="flex items-center space-x-3">
            <button className="flex items-center space-x-2 px-3 py-1.5 bg-primary-500 text-primary-on-500 text-sm rounded hover:bg-primary-700">
            ...
            <div className="bg-white border border-neutral-200 rounded-lg p-4 min-h-64">
              <div className="space-y-3">
                <div className="flex items-center space-x-2 p-2 bg-neutral-100 rounded">
                  <div className="w-6 h-6 bg-primary-500 rounded flex items-center justify-center text-white text-xs font-medium">1</div>
                  <svg className="w-4 h-4 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center space-x-2 p-2 bg-neutral-100 rounded">
                  <span className="text-sm text-neutral-600">Partial Submit Point</span>
                  <svg className="w-4 h-4 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </div>
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-center p-8">
                <div className="text-left max-w-md w-full">
                  <div className="text-neutral-300 text-sm mb-2">1 → Your question here. Recall information with @</div>
                  <div className="text-neutral-400 text-xs mb-4">Description (optional)</div>
                  
                  <div className="space-y-2 mb-4">
                    <button className="w-full text-left p-3 border border-neutral-600 rounded hover:bg-neutral-800 text-white">
                      A Choice 1
                    </button>
                    <button className="w-full text-left p-3 border border-neutral-600 rounded hover:bg-neutral-800 text-white">
                      B Choice 2
